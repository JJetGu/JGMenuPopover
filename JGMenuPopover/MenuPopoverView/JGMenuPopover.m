...
#define MENU_POINTER_RECT       CGRectMake(frame.origin.x + self.frame.size.width - 30, frame.origin.y, 23, 11)
#define MENU_LeftPOINTER_RECT       CGRectMake(frame.origin.x + 10, frame.origin.y, 23, 11)
...
- (id)initWithFrame:(CGRect)frame menuItems:(NSArray *)aMenuItems isLeft:(BOOL)left
{
    ...
    if (self)
    {
        ...
        UIImageView *menuPointerView = [[UIImageView alloc] initWithFrame:(left)? MENU_LeftPOINTER_RECT : MENU_POINTER_RECT];
        ...
        menuItemsTableView.layer.cornerRadius = 4.0f;
        menuItemsTableView.layer.masksToBounds = YES;
        menuItemsTableView.backgroundColor = UIColorFromRGB(0x4fc0e8);
